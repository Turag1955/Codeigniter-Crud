...
<head>
	...
	<link id="base-style-responsive" href="../frontend/css/custom.css" rel="stylesheet">
	<link
...
<body>
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="index.html"><span>CRUD</span></a>
				...
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							...
							<i class="icon-user"></i>
								<span class="hidden-tablet">Student</span>
								</a>
						</li>
						<li>
							<a href="<?php echo base_url()?>admin/show">
	...
	<footer>
		<p>
			<span style="text-align:left;float:left">&copy; 2021 <a href="http://bootstrapmaster.com/"
					alt="Bootstrap Themes">CRUD</a></span>
			<span class="hidden-phone" style="text-align:right;float:right">Powered by: <a
					href="http://admintemplates.co/" alt="Bootstrap Admin Templates">TURAG</a></span>
		</p>
