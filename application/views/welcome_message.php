...
<head>
	...
	<style type="text/css">
		body {
			background: url(frontend/img/bg-login.jpg) !important;
		}
		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="login-box">
					...
					<form class="form-horizontal" action="<?php echo base_url()?>login"
						method="post">
						<fieldset>

							<div class="input-prepend" title="email">
								<span class="add-on"><i class="halflings-icon user"></i></span>
								<input class="input-large span10" name="email" id="email" type="email"
									placeholder="Email" />
							</div>
